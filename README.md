...
**项目说明** 
- 是一个轻量级的Java快速开发平台，基于各大开源项目组合而来，用于快速构建中小型API、RESTful API项目，该项目已经有过多个真实项目的实践，稳定、简单、快速，使我们摆脱那些重复劳动。
...
- 后台部署
 ```
   1、 $git clong https://github.com/chenlinxp/JustDo-boot2.0.git
 ...
 ```
    ...
    2、 在server中修改 root 和 index  
        ...
        server {
            ....
            #静态页面目录
            root  /Users/chenlin/Documents/GitHub/JustDo-boot2.0/justdo-ui;
            #默认首页
            index  login.html;
            ....
...
```
1) 看看application.properties 配置文件中 spring.profiles.active: dev  
   当前配置的是dev ,就修改application-dev.properties 中的数据库连接IP用户密码
