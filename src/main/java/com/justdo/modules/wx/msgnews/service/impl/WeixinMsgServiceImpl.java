package com.justdo.modules.wx.msgnews.service.impl;

import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.justdo.modules.wx.msgnews.service.MsgNewsService;
...
public class WeixinMsgServiceImpl implements WeixinMsgService {
    ...
    public void replyMsgMenu(String toUser, String msgMenusJson) throws WxErrorException {
        ...
        List<WxMpKefuMessage.MsgMenu> msgMenus = json.getJSONArray("list").toList(WxMpKefuMessage.MsgMenu.class);
        wxService.getKefuService().sendKefuMessage(
